...
> Nous avons lancé un essai de réduction de la sollicitation des DPA le
> **12/6/2025 M** en ajustant les paramètres de fonctionnement :
>
> -   Cuves d'essai : **68 cuves** à cycle anodique de 76 postes
> -   **HBC passe de 18 à 19cm** sur les cuves d'essai et de 17 à 18cm
>     sur les cuves de référence
> -   **TPI à 1.4s** (temps d'activation des DPA quand le contact
>     pointerolle ne fonctionne pas)
> -   **TPIMO à 0.7s** (temps minimum d'activation des DPA)
> -   **NOCOPI à 1333** ( modification du 12/6 annulée par une loi de
>     démarrage le 12/6 et corrigée le 16/6 M)
...
dmodel |> 
  ...
  geom_line(linewidth = 1.1) +
  scale_y_continuous(breaks = seq(1.3, 1.7, .1)) +
...
dmodel |> 
  ...
  geom_vline(xintercept = as_date(ymd(dat_deb_essai_plot))) +
  customColors::scale_color_potline(name = "", rev = T) +
  labs(title = "Nb piquage DPA moyen jour", x = "", y = "#")
