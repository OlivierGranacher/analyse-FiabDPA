...
model_sea <- glmmTMB(
  ...
  ziformula = ~ groupe_ * period_essai_,
  family = truncated_nbinom2(),  # or truncated_nbinom2() if overdispersed
  data = dmodel
)

# Summary of the model
#summary(model_sea)
sjPlot::tab_model(model_sea, title = "Modèle lmer sea", digits = 1)
```
